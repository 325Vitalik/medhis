		...
		<Segment loading={isLoading}>
			{isError && (
				<Message negative>
					...
					<p>Спробуйте перезаватажити сторінку, якщо помилка повториться зверніться до служби підтримки</p>
				</Message>
			)}
			{!isError && patient && (
				<Grid>
					<Grid.Column width={4}>
						<Image style={{minHeight: '100%', maxHeight: '30vh', objectFit: 'cover'}} size="medium" src={patient.imageUrl} />
					</Grid.Column>
